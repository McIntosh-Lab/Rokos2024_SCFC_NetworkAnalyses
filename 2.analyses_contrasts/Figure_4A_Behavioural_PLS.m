...
% Bootstrap Ratio (BSR) values, and plots the bPLS constrast for Figure 4A.
...
%      a) `datamat_lst{1}`: Ensure this is set to the brain metric of interest (i.e., SC_clustering).
...
%       a) Ensure the LV of interest is set to 2.
...
% File Names
bPLS_results_file = 'FIGURE4A_bPLS.mat'; % MODIFY file name for saving bPLS results
figure_filename = 'FIGURE4A.png'; % MODIFY file name for saving the contrast figure
bsr_csv_filename = 'FIGURE4A_bsrs.csv'; % MODIFY file name for saving significant BSR values
